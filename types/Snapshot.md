...
This query returns the proposal result for a given proposal id (an IPFS hash for a certain proposal) coming from [Snapshot](https://snapshot.org/#/). It takes an optional 
